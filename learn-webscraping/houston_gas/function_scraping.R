...
scrape_city_url <- function(county_url){
  ...
  glue("https://www.gasbuddy.com{city}")
}
...
scrape_county_url <- function(state_url){
 counties <- read_html_live(state_url) |> 
  ...
  glue("https://www.gasbuddy.com{counties}")
