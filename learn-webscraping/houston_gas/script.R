...
mainh <- read_html_live("https://www.gasbuddy.com/gasprices")
...
city <- read_html_live("https://www.gasbuddy.com/gasprices/texas/harris/3094") |>
  html_elements( css = ".DataGrid-module__link___1Pa9Z")|>
  html_attr( name = "href")
...
gas_stat <- read_html_live("https://www.gasbuddy.com/gasprices/texas/south-houston")|>
...
# get station location
 ...
 location <- read_html_live("https://www.gasbuddy.com/station/81176") |>
   html_element( css = ".StationInfoBox-module__ellipsisNoWrap___1-lh5 , .StationInfoBox-module__ellipsisNoWrap___1-lh5 span" ) |>
   html_text()
 ...
 rprice  <- read_html_live("https://www.gasbuddy.com/station/81176") |>
  ...
  mprice  <- read_html_live("https://www.gasbuddy.com/station/81176") |>
   html_element( css = ".GasPriceCollection-module__priceDisplay___1pnaL:nth-child(2) .FuelTypePriceDisplay-module__price___3iizb") |>
   html_text()
...
# get price for premium
  ...
  pprice  <- read_html_live("https://www.gasbuddy.com/station/81176") |>
    html_element( css = ".GasPriceCollection-module__priceDisplay___1pnaL~ .GasPriceCollection-module__priceDisplay___1pnaL+ .GasPriceCollection-module__priceDisplay___1pnaL .FuelTypePriceDisplay-module__price___3iizb") |>
    html_text()
